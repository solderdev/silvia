// SH1106 oled display 1.3" 128*64

// coffee cup: https://github.com/olikraus/u8g2/wiki/u8g2reference#drawglyph
// #define GLYPH_COFFEECUP  0x2615
// u8g2.setFont(u8g2_font_unifont_t_symbols);
// u8g2.drawGlyph(5, 20, GLYPH_COFFEECUP);
...
{
  if (millis() - Dlastmilli > 500 )
  {
    Dlastmilli = millis();

  //  u8g2.drawStr(col, pos, "Hello World!");  // write something to the internal memory
