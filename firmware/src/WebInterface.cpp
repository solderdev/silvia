...
//  MDNS.addService("http", "tcp", 80);
  ...
  // route to pump a little water
  server_.on("/waterfill", HTTP_POST, [](AsyncWebServerRequest *request) {
    request->send(200);
    WaterControl::getInstance()->overridePump(100, PUMP_OVERRIDE_MS);
  });
